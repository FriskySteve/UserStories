...
use Frisky\AddressBookBundle\Entity\Phone;
...
class PhoneController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $phones = $em->getRepository('ABBundle:Phone')->findAll();
    ...
    {
        $phone = new Phone();
        $form = $this->createForm('Frisky\AddressBookBundle\Form\PhoneType', $phone);
    ...
    {
        $deleteForm = $this->createDeleteForm($phone);
        $editForm = $this->createForm('Frisky\AddressBookBundle\Form\PhoneType', $phone);
