...
use Frisky\AddressBookBundle\Entity\Address;
...
class AddressController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $addresses = $em->getRepository('ABBundle:Address')->findAll();
    ...
    {
        $address = new Address();
        $form = $this->createForm('Frisky\AddressBookBundle\Form\AddressType', $address);
    ...
    {
        $deleteForm = $this->createDeleteForm($address);
        $editForm = $this->createForm('Frisky\AddressBookBundle\Form\AddressType', $address);
