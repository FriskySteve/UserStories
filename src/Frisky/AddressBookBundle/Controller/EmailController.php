...
use Frisky\AddressBookBundle\Entity\Email;
...
class EmailController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $emails = $em->getRepository('ABBundle:Email')->findAll();
    ...
    {
        $email = new Email();
        $form = $this->createForm('Frisky\AddressBookBundle\Form\EmailType', $email);
    ...
    {
        $deleteForm = $this->createDeleteForm($email);
        $editForm = $this->createForm('Frisky\AddressBookBundle\Form\EmailType', $email);
